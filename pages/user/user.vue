	...
	<view class="userLayout pageBg" v-if="userInfo">
		...
		<view class="section">
			<view class="list">
				...
				<navigator class="row" url="/pages/notice/detail?id=653507c6466d417a3718e94b&name=订阅更新">
					<view class="left">
				...
				<navigator class="row" url="/pages/notice/detail?id=6536358ce0ec19c8d67fbe82&name=常见问题">
					<view class="left">
